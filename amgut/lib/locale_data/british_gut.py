...
media_locale = {
    ...
    'SHIPPING_ADDRESS': 'British Gut<br/>Department of Twin Research, Kings College London,<br/>St Thomas’ Hospital Campus, 3rd Floor South Wing Block D<br/>Westminster Bridge Road, London SE1 7EH'
}
...
_FAQ = {
    ...
    'INTRODUCTION_WHAT_IS_GUT': "<p>Your gut is a hole that runs through your body. Your gut is actually, developmentally speaking, the outside of your body, but it has evolved many intricacies that make it seem like the inside. Your gut starts with your mouth and ends with your anus. In between food is changed into energy, feces, bacteria, viruses and a few other things. Your gut exacts a kind of metamorphosis on everything you eat, turning hotdog or grilled cheese, miraculously, into energy and, ultimately, cells, signals and even thoughts. We are only beginning to understand this process, a process in which microbes play (or fail to play) a major role.</p>",
...
_DB_ERROR = {
    ...
    'SIGNOFF': "Thanks, <br /> The %(project_shorthand)s Team" % {'project_shorthand': AMGUT_CONFIG.project_shorthand},
}
